...
class TriggerValidatorTest {
    ...
    TriggerDefinition trigger =
        trigger(
            new DailyTimeIntervalTriggerSpec(
                15, ChronoUnit.MINUTES, Set.of(), LocalTime.of(8, 0), LocalTime.of(18, 0)),
            "Asia/Ho_Chi_Minh",
            TriggerDefinition.MisfirePolicy.FIRE_ONCE_NOW);
  ...
  void rejectsOnceTriggerWithoutFutureFireTime() {
    TriggerDefinition trigger =
        trigger(new OnceTriggerSpec(NOW), null, TriggerDefinition.MisfirePolicy.FIRE_NOW);
  ...
  void acceptsSupportedTriggerVariants() {
    ...
    assertThatCode(
            () ->
                validator.validate(
                    trigger(
                        new SimpleIntervalTriggerSpec(Duration.ofSeconds(5), 10L),
                        null,
    ...
    assertThatCode(
            () ->
                validator.validate(
                    trigger(
                        new CalendarIntervalTriggerSpec(1, ChronoUnit.MONTHS),
                        "Asia/Ho_Chi_Minh",
                        TriggerDefinition.MisfirePolicy.FIRE_ONCE_NOW),
                    NOW))
        .doesNotThrowAnyException();
  ...
  private static TriggerDefinition trigger(
      TriggerSpec spec, String timezone, TriggerDefinition.MisfirePolicy misfirePolicy) {
